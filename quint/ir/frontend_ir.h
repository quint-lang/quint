...
#include "quint/common/exceptions.h"
...
//        MemoryAccessOptions mem_access_opt;
    ...
    public:
        ...
        std::string name;
        SNode *snode{nullptr};
        SNodeGradType grad_type{SNodeGradType::kPrimal};
        ...
        FieldExpression(const Identifier &ident, const DataType &dt) : ident(ident), dt(dt) {
        }
